...
def build_journey_analysis_messages(
    *,
    ...
    user = (
        ...
        "4. For EACH step, generate 3-5 specific user actions (viewing, reading, scrolling, clicking, filling)\n"
        "5. Use exact text from scraped content for all descriptions\n"
        "6. Reference actual CTAs, forms, and content elements\n"
        "7. Include granular actions like 'Read headline', 'Scroll to testimonials', 'Click CTA button'\n"
        "8. Identify real friction points based on what's missing or unclear\n"
        "9. Suggest optimizations based on actual content gaps\n\n"
        "MICROBEHAVIOR TARGET: Generate 6-9 total user actions across all journey steps.\n"
        "Focus on the MOST CRITICAL actions for conversion - quality over quantity.\n\n"
...
def build_granular_actions_messages(
    *,
    ...
    system = (
        ...
        "Do not include markdown, prose, or comments.\n\n"
        "FOCUSED CONVERSION SEQUENCE: Create 6-9 critical steps like:\n"
        "Goal: 'Book consultation call'\n"
        "1. 'Land on page from Google search'\n"
        "2. 'Read headline: [actual headline]'\n"
        "3. 'Scroll to view key sections'\n"
        "4. 'Read testimonials for trust building'\n"
        "5. 'Click \"Book Free Call\" button'\n"
        "6. 'Fill contact form fields'\n"
        "7. 'Select available time slot'\n"
        "8. 'Confirm booking submission'\n"
